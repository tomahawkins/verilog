...
signalBindings = do { tok Sym_paren_l; a <- commaList signalBinding; tok Sym_paren_r; return a }

signalBinding :: Verilog (Identifier, Maybe Expr)
signalBinding = do { tok Sym_dot; a <- identifier; tok Sym_paren_l; b <- optional expr; tok Sym_paren_r; return (a, b) }
